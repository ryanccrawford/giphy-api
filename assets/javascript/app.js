...
var gifCount = 0,
    ...
    endPoints = function () { //this object is used to create an endpoint to pass to the search function
        return {
            ...
            gifid: function (gif_id) {
                return '/gifs/' + gif_id
            }, // { gif_id } GET Get GIF by ID Endpoint
    ...
    textColors = {
        'lightgreen': 'white', // this was used to convert text color to easy to read color based on background color
        'green': 'white',
        'darkgreen': 'white',
        'yellow': 'black',
        'red': 'white',
